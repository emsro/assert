...
struct asrt_stream_record
{
        struct asrt_stream_record* next;
...
struct asrt_stream_schemas
{
        struct asrt_stream_schema* schemas;       ///< Allocated array of schemas.
