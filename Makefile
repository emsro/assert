...
clang-tidy:
	...
	find ./asrtc ./asrtl ./asrtr ./asrtio ./asrtcpp ./asrtlpp ./asrtrpp ./test \( -iname "*.h" -o -iname "*.c" -o -iname "*.cpp" -o -iname "*.hpp" \) | xargs clang-tidy -p ./_build/ $$EXTRA --warnings-as-errors='*'
