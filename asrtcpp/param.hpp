...
ASRT_NODISCARD inline status init( asrt_param_server& srv, asrt_node& prev, asrt_allocator alloc )
{
...
inline void set_tree( asrt_param_server& srv, asrt_flat_tree const& tree )
{
...
inline void deinit( asrt_param_server& srv )
{
...
inline ecor::sender auto send_ready( asrt_param_server& srv, flat_id root_id, uint32_t timeout )
{
